      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <NavLink to="/" className="text-3xl font-extrabold tracking-widest text-white mb-4 inline-block">
              KRAFTVRK
            </NavLink>
          ...
          {/* Working Hours */}
          <div>
            <h4 className="text-xl font-bold text-white uppercase tracking-wider mb-4">{t('footer.workingHours')}</h4>
            <p className="text-sm">{t('footer.weekdays')}: <span className="text-gray-200 ml-2">6:00 - 20:00</span></p>
            <p className="text-sm mt-2">{t('footer.saturday')}: <span className="text-gray-200 ml-2">9:00 - 12:00</span></p>
            <p className="text-sm mt-2">{t('footer.sunday')}: <span className="text-gray-200 ml-2">{t('footer.closed')}</span></p>
          </div>

          {/* Contact Info */}
          <div>
            <h4 className="text-xl font-bold text-white uppercase tracking-wider mb-4">{t('footer.contactInfo')}</h4>
          ...
          {/* Gallery placeholder */}
           <div>
            <h4 className="text-xl font-bold text-white uppercase tracking-wider mb-4">{t('footer.gallery')}</h4>
