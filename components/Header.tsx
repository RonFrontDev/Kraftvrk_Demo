...
const Header = (): React.ReactNode => {
  ...
  const isAboutActive = location.pathname.startsWith('/about') || location.pathname.startsWith('/coaches') || location.pathname.startsWith('/classes') || location.pathname.startsWith('/members') || location.pathname.startsWith('/what-is-crossfit');
        ...
        <div className="flex items-center justify-between h-24">
          ...
          <nav className={`hidden lg:flex items-center space-x-8 ${navTextColorClass}`}>
            ...
            <div className="relative group py-6 -my-6">
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-56 bg-white dark:bg-[#181818] shadow-lg rounded-md p-2 opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300 ring-1 ring-black ring-opacity-5">
