        ...
        <div className="text-center h-full flex flex-col justify-center min-h-[300px]">
            ...
            <div className="flex justify-center mb-6">
                <div className="inline-flex rounded-md shadow-sm bg-gray-200 dark:bg-gray-900 p-1 border border-gray-300 dark:border-gray-700">
                    <button onClick={() => onWodTypeChange('individual')} className={`px-4 sm:px-6 py-2 text-sm font-medium uppercase tracking-wider rounded-l-md transition-colors duration-200 ${wodType === 'individual' ? 'bg-accent text-black' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-700'}`}>
                    ...
                    <button onClick={() => onWodTypeChange('competition')} className={`px-4 sm:px-6 py-2 text-sm font-medium uppercase tracking-wider rounded-r-md transition-colors duration-200 ${wodType === 'competition' ? 'bg-accent text-black' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-700'}`}>
