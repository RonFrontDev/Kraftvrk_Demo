      ...
      <div className="bg-[#1c1c1e] p-8 text-center h-full flex flex-col justify-center min-h-[300px]">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex rounded-md shadow-sm bg-gray-900 p-1 border border-gray-700">
            <button onClick={() => setWodType('individual')} className={`px-6 py-2 text-sm font-medium uppercase tracking-wider rounded-l-sm transition-colors duration-200 ${wodType === 'individual' ? 'bg-accent text-black' : 'text-gray-300 hover:bg-gray-700'}`}>
              {t('wod.typeIndividual')}
            </button>
            <button onClick={() => setWodType('team')} className={`px-6 py-2 text-sm font-medium uppercase tracking-wider rounded-r-sm transition-colors duration-200 ${wodType === 'team' ? 'bg-accent text-black' : 'text-gray-300 hover:bg-gray-700'}`}>
              {t('wod.typeTeam')}
            </button>
          </div>
        </div>
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button onClick={handleWriteClick} disabled={isLoading} className="flex-1 bg-gray-600 text-white font-bold py-3 px-8 text-lg uppercase tracking-wider rounded-sm hover:bg-gray-500 transition-all duration-300 transform hover:scale-105 disabled:bg-gray-800 disabled:cursor-not-allowed">
            {t('wod.writeOwnWod')}
          </button>
        </div>
      </div>
